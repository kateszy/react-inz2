    ...
    return (
        <Container className="mw100">
            <Row>
                ...
                <Col xs lg="3" className="mw200"> <a href="/products/tshirts"><img className="cat" src={g1} /> <h2> Bluzy </h2><small> shop <FontAwesomeIcon icon={faLongArrowAltRight} color="rgb(202, 255, 202)"className="arrow" /></small></a></Col>
                </div>
            </Row>
        </Container>
